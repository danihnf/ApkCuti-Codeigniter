    ...
    <section class="content">
      ...
      <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Konfirmasi Cuti </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <!-- /.box-header -->
              ...
              <thead>
                ...
                <tr>
                      ...
                      <td><?php 
                       ...
                       ?></td> 
                      <td><?php echo date( 'd F Y', strtotime($obj->mulai)); ?></td> 
                      <td><?php echo date( 'd F Y', strtotime($obj->akhir)); ?></td> 
                      <td><?php echo $obj->stok_cuti; ?></td> 
                      ...
                      <td>
                        ...
                        <button type="submit" class="btn btn-warning">Konfirmasi</button>
                          ...
                          <a href="javascript:if(confirm('Anda yakin ingin menghapus data?')){document.location='<?php echo base_url(); ?>C_konfirmasi/hapusCuti/<?php echo $obj->id; ?>';}"><button type="button" class="btn btn-danger glyphicon glyphicon-trash"></button> </a>
                        </form>
                      </td>
