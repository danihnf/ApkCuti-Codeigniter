        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url(); ?>admin/dist/img/user2-160x160.jpg" alt="User profile picture">
              ...
              <a href="#" class="btn btn-primary btn-block"><b>Apdet Foto</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div>
                <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>C_dashboard/apdetuser/<?php echo $nik; ?>">
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Nik</label>

                    <div class="col-sm-10">
                      <input type="email" class="form-control" value="<?php echo $nik; ?>" id="inputName" placeholder="Name" disabled>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="nama" type="text" value="<?php echo $nama; ?>" class="form-control" placeholder="Email">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="<?php 
                       ...
                       ?>" class="form-control" id="inputName" placeholder="Name" disabled>
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <label for="inputSkills" class="col-sm-2 control-label">Ubah Password</label>

                    <div class="col-sm-10">
                      <input name="password" type="password" class="form-control" id="inputSkills" placeholder="Ubah Password">
                    </div>
                  </div>
    ...
    <!-- Small boxes (Stat box) -->
      ...
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
          ...
          <a href="<?php echo base_url(); ?>C_dashboard/user" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      <!-- ./col -->
      <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-yellow">
          ...
          <a href="<?php echo base_url(); ?>C_konfirmasi" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
